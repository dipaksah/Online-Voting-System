                ...
                <!-- Menu Area -->
                   <div class="collapse navbar-collapse" id="ca-navbar">
                      ...
                      <ul class="navbar-nav ml-auto" id="nav">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#features">Blogs</a></li>

                        <li class="nav-item"><a class="nav-link" href="#testimonials">Help</a></li>

                        <li class="nav-item"><a class="nav-link" href="#team">Admin Login</a></li>
   ...
   <div id="Slider" class="carousel slide" data-ride="carousel">
   	 ...
   	 <div class="carousel-inner slider-image-control">
   	 	<div class="carousel-item active">
   	 		...
   	 		<div class="carousel-caption" class="welcome">
   	 			<a href="login.php"><button type="button" class="btn btn-outline-light btn-lg bg-primary">Login To Access</button></a>
   	 			<h1 class="display-2">Online Voting System</h1>
   	 			<h3>Your Vote is Your Voice</h3>
   	 			<button type="button" class="btn btn-outline-light btn-lg bg-primary">VIEW DEMO</button>
   	 			<button type="button" class="btn btn-outline-light btn-lg bg-primary">GET STARTED</button>
   	 		</div>
   	 	</div>
                        ...
                        <form action="controller" method="post">
                            ...
                            <div class="contact_input_area">
                                <div class="row">
                                    ...
                                    <!-- Single Input Area Start -->
                                    <div class="col-12">
                                        <div class="button3D"><a><button type="submit" class="btn btn-outline-light btn-lg bg-primary">Send Now</button></a></div>
                                    </div>
                                </div>
                            </div>
