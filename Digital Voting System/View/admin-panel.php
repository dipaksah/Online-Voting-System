                ...
                <div class="col-md-10 content">
                    <div class="admin-panel">
                        ...
                        <div class="admin-block">
                            <h1>Private dashboard controled by admin.</h1>
                            <h3>Securly and safely</h3>
                            <h3>Digital Voting System Admin DashBoard</h3>
                        </div>
                        <h2>Administraion</h2>
                        <p>What is an admin panel you may ask? It’s an admin-specific platform in an application that allows for access and manipulation of data within the user interface of the site. The admin panel can help user-related functions, such as providing insight into user behavior, dealing with profiles that violate the site’s terms and conditions, and tracking transactions. But you should know that admin sites are not just limited to user-related tasks.</p>
                    </div>
                </div>
            </div>
        </div>
